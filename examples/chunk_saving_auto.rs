//! ===========================================================================
//! chunk_saving_auto.rs - Automatic chunk saving/loading
//! ===========================================================================
...
fn main() {
    App::new()
        ...
        .init_resource::<ChunkManagerResource<AutoWorldChunks>>()
        .register_chunk_data::<TerrainData>()
        // Enable unloading
        .insert_resource(ChunkUnloadLimit { max_chunks: 50 })
        .insert_resource(ChunkUnloadByDistance)
        .add_systems(Startup, setup_auto)
        .add_systems(Update, (move_loader, show_info, visualize_chunks_auto))
        .run();
}
